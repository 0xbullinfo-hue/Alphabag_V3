...
const AlphaBag = lazy(() => import('./pages/AlphaBag').then(m => ({ default: m.AlphaBag })));
    ...
    <>
      ...
      <Suspense fallback={<GlobalLoader />}>
        <Routes>
          ...
          <Route path="/alpha-bag" element={<PrivateRoute><AlphaBag /></PrivateRoute>} />
          ...
          <Route path="/reward" element={<Navigate to="/earn" replace />} />
