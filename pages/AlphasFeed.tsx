    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className={`max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 transition-all duration-700 ${showOnboarding ? 'blur-2xl pointer-events-none scale-95 opacity-50' : 'blur-0 opacity-100 scale-100'}`}>
                ...
                {/* Left Sidebar Spacer / Nav could go here in future */}
                <div className="hidden lg:block lg:col-span-1"></div>

                {/* Main Feed */}
                <div className="lg:col-span-7 border-x border-white/5 min-h-screen">
                    {/* Top Tabs */}
                    <div className="sticky top-0 z-10 bg-alphabag-black/80 backdrop-blur-xl border-b border-white/5">
                        <div className="flex w-full">
                            {['For you', 'Following', 'AlphaXP'].map((label, i) => {
                                const tab = i === 0 ? 'FOR_YOU' : i === 1 ? 'FOLLOWING' : 'ALPHABAG';
                                return (
                                    <button
                                        key={label}
                ...
                {/* Sidebar Widgets */}
                <div className="lg:col-span-4 py-4 space-y-4 sticky top-4 h-fit">
        ...
        <div className="p-4 hover:bg-white/[0.02] transition-colors cursor-pointer border-b border-white/5">
            <div className="flex gap-4">
                ...
                <div 
                    ...
                    className="w-10 h-10 flex-shrink-0 bg-alphabag-black border border-white/10 rounded-full flex items-center justify-center font-black text-alphabag-yellow shadow-inner overflow-hidden uppercase cursor-pointer hover:border-alphabag-yellow/50 transition-all"
                >
                    {post.logoUrl ? (
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {/* Content */}
                    <p className="text-zinc-200 text-[15px] leading-normal mb-3 whitespace-pre-wrap">
                        {post.content}
                    </p>
                    ...
                    {/* Interactions */}
                    <div className="flex items-center justify-between -ml-2 max-w-md text-alphabag-muted">
                        <button 
                        ...
                        >
                            ...
                            <span className="text-xs">{post.commentCount || 687}</span>
                        </button>
                        <button 
                        ...
                        >
                            <Share2 size={18} />
                            <span className="text-xs">{post.shareCount || 233}</span>
                        </button>
                        <button 
                            onClick={handleLike}
