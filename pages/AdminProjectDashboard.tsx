...
const MOCK_SUBMISSIONS: ProjectSubmission[] = [
    { id: '1', name: 'AlphaXP Pro', symbol: 'BAG', founder: 'Founder_Alpha', status: 'PENDING', createdAt: '2026-03-15' },
                    ...
                    <div className="glass-panel p-6">
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-alphabag-yellow/5 border border-alphabag-yellow/20 rounded-xl">
                                ...
                                <div className="text-xs font-bold text-white">AlphaXP Pro Campaign</div>
                            </div>
