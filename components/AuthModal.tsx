...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  const carouselSteps = [
    ...
    },
    {
      ...
      description: "Execute missions in the Mission Hub to earn XP. Every action brings you closer to the elite Syndicate tier and higher token allocations. Ensure to claim daily/weekly XP.",
