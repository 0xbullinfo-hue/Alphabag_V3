...
import { LayoutDashboard, Newspaper, Wallet, Layers, BarChart3, Bot, Link as LinkIcon, Settings, LogOut, Calculator, Eye, Radio, ShieldCheck, Briefcase, PieChart, FileClock, Flame, Zap, ChevronDown, Gift, Trophy, UserCircle, Target } from 'lucide-react';
      ...
      `}>
        <div className="py-2">
          <NavGroup title="Personal">
            ...
            <div className="relative">
              <NavItem to="/earn" icon={Target} label="Reward Hub" active={location.pathname === '/earn'} />
              <div className="absolute right-6 top-1/2 -translate-y-1/2 px-1.5 py-0.5 bg-alphabag-green text-black text-[7px] font-black rounded uppercase pointer-events-none">T2E</div>
            </div>

            <NavDropdown 
              icon={Briefcase} 
              label="My Hub" 
              activePaths={['/alpha-bag', '/cex-bag', '/dex-bag', '/settings', '/integrations']}
            >
              <NavItem to="/alpha-bag" label="Overview" active={location.pathname === '/alpha-bag'} />
              <NavItem to="/cex-bag" label="CEX HUB" active={location.pathname === '/cex-bag'} />
              <NavItem to="/dex-bag" label="DEX HUB" active={location.pathname === '/dex-bag'} />
              <NavItem to="/settings" label="Setup Connections" active={location.pathname === '/settings'} />
              <NavItem to="/integrations" label="Integrations" active={location.pathname === '/integrations'} />
            </NavDropdown>
